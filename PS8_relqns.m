...
for idx = 2:num_points
    ...
    x_kk1 = F * x_k1k1 + (sqrtm(sigma_roe) * randn(6, 1));
    % ---------------------------------------
...
roe_labels = {'a\deltaa error [m]','a\delta\lambda error [m]','a\deltae_x error [m]','a\deltae_y error [m/s]','a\deltai_x error [m/s]','a\deltai_y error [m/s]'};
